...
//bool testStepCalibration(){
//
//    vector<cv::Mat> images;
//    vector<vector<cv::Mat>> allImages;
//    Calibrator *calibrator = new Calibrator("data/config.xml");
//
//    images.push_back(cv::imread("data/grab1_1.jpg")); // Center
//    images.push_back(cv::imread("data/grab2_1.jpg")); // Plus X
//    images.push_back(cv::imread("data/grab0_1.jpg")); // Plus Y
//
